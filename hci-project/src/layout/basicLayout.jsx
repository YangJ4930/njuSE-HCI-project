    ...
    return (
            <Layout style={{backgroundColor: "rgba(0,0,0,0.9)"}} >
                ...
                <div style={{display: isVisible ? 'flex' : 'none' , justifyContent: 'center'}}>
                    <Footer style={{textAlign: 'center', justifyContent: 'center', alignItems: 'center', backgroundColor:"rgba(10,10,10, 0.9)"}}>
                        <div style={{color: "white"}}><b>J Game</b> ©2023 Created by J Game</div>
                    </Footer>
                </div>
            </Layout>
    );
...
const BasicBar = () => {
    ...
    if (location.pathname.startsWith("/user") || location.pathname.startsWith("/component") || location.pathname.startsWith("/search")) {
