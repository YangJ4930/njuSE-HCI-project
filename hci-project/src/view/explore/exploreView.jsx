        ...
        <div>
                ...
                <Flex justify='space-between' align='center' horizontal>
                    ...
                    <Flex>
                        <div className='css-1525v2c' data-testid='prev-button'>
                            <button
                                className='css-17tg536'
                                disabled=''
                                aria-label='上一张幻灯片'
                                tabIndex='0'
                            >
                                <span className='css-12wf8hj' aria-hidden='true' data-testid='icon'>
                                    <svg
                                        xmlns='http://www.w3.org/2000/svg'
                        ...
                        <div className='css-1525v2c' data-testid='next-button'>
                            <button className='css-17tg536' aria-label='下一张幻灯片' tabIndex='0'>
                                <span className='css-13x459g' aria-hidden='true' data-testid='icon'>
                                    <svg
                                        xmlns='http://www.w3.org/2000/svg'
                                        className='svg css-uwwqev'
                                        viewBox='0 0 5 9'
            ...
            <Flex gap='middle' align='start' vertical>
                <Flex style={{ width: '100%', height: 200 }} justify='space-between' align='center'>
                    ...
                    />
                    <img
                        alt='《Sherlock Holmes The Awakened》标准版'
        ...
        <div>
            <Flex justify='space-between' align='center' horizontal>
                <Flex gap='small' align='start' vertical>
                    ...
                    <h6 style={{ color: 'rgba(190, 190, 190)' }}>
                        来体验 2023 年度最大的更新。全新 8x8 地图 RONDO。
                    </h6>
                </Flex>
                <Flex gap='small' align='start' vertical>
                    <img
                    ...
                    <h6 style={{ color: 'rgba(190, 190, 190)' }}>
                        本周末来免费试玩《Chivalry 2》及其更新，更可四折购买
                    </h6>
                </Flex>
            </Flex>
        </div>
